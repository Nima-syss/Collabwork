...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare('SELECT id, fullname, username, email, balance, password_hash FROM users WHERE email = ?');
    ...
    $stmt->bind_result($id, $fullname, $username, $storedEmail, $balance, $passwordHash);
    $stmt->fetch();
    $stmt->close();
    ...
    $_SESSION['total_balance'] = (float) $balance;
